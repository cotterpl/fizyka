...
Prawo Archimedesa dotyczy także **gazów**: na ciało otoczone gazem (np. powietrzem) działa siła wyporu równa co do wartości ciężarowi gazu wypartego przez to ciało — we wzorze zamiast `ρ_cieczy` wstawiamy wtedy gęstość gazu. Dlatego balon wypełniony helem (gazem o mniejszej gęstości niż powietrze) wznosi się do góry.
...
- jeśli `ρ_ciała = ρ_cieczy` → ciężar równa się sile wyporu przy pełnym zanurzeniu → **ciało pływa całkowicie zanurzone** — „zawisa” wewnątrz cieczy (nie tonie i nie wypływa na powierzchnię),
