...
**5. Odpowiedź: C (`5000 Pa`).**
Ciśnienie hydrostatyczne jest wprost proporcjonalne do głębokości (`p = ρgh`). Skoro przy `h = 20 cm` mamy `p = 2000 Pa`, to `p/h = 100 Pa/cm`. Przy `h = 50 cm`: `p = 50 cm × 100 Pa/cm = 5000 Pa`.
