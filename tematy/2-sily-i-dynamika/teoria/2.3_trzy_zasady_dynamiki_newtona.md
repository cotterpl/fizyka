...
Krótko: siły równoważące się działają zawsze na **jedno** ciało (przy czym siły działające na jedno ciało mogą, ale nie muszą, się równoważyć). Siły z pary akcja–reakcja działają zawsze na **dwa różne** ciała i mają zawsze taką samą wartość — to nie jest "równoważenie się", bo równoważenie dotyczy sił działających na to samo ciało.
