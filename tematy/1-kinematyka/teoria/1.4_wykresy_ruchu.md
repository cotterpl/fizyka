...
Wykres, który by się obniżał, opisywałby inną wielkość — *położenie* (informację, w którym miejscu na trasie akurat jesteśmy), a nie drogę. To rozróżnienie poznasz szczegółowo w starszych klasach (przemieszczenie). W tym rozdziale zajmujemy się wyłącznie drogą, więc pamiętaj: **wykres s(t) jest zawsze niemalejący**, niezależnie od tego, jak skomplikowaną trasę (nawet z zawracaniem) pokonuje ciało.
