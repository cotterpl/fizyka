...
**Dziwne pytanie:** Do wejścia na tę samą wysokość mogę użyć krótkich, stromych schodów albo długiej, łagodnej rampy dla wózków. Pomijając tarcie, praca potrzebna do wniesienia tego samego ciężaru na tę samą wysokość jest identyczna (W = Q · h, niezależnie od trasy) — to skąd bierze się wrażenie, że rampa jest "łatwiejsza"?
