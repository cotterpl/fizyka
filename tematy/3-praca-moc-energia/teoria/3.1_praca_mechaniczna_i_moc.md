...
Z punktu widzenia fizyki mechanicznej — tak, dokładnie zero. We wzorze W = F · s droga s, jaką pokonuje walizka, wynosi 0 (nie zmienia ani wysokości, ani położenia), więc niezależnie od tego, jak wielką siłą ją podpierasz: W = F · 0 = 0 J.
