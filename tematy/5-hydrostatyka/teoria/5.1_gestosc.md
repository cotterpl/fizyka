...
- `d` — gęstość (skalar; czasem oznaczana grecką literą ρ, czyt. „ro")
- `m` — masa ciała (skalar)
...
*Rys. 1. Sześcian o krawędzi `a` i masie `m`. Objętość `V = a · a · a = a³`, a gęstość `d = m / V`.*

### Ciekawostka: wieża z siedmiu cieczy, które „nie chcą się wymieszać"
...
### Ciekawostka: sześcian, który zważyłby tyle, co przedszkolak

Osm to najgęstszy pierwiastek, jaki znamy — jego gęstość wynosi około 22,6 g/cm³, czyli ponad 20 razy więcej niż gęstość wody. Sześcian z osmu o krawędzi zaledwie 10 cm (mniejszy niż piłka do koszykówki) ważyłby `m = d · V = 22,6 g/cm³ × 1000 cm³ ≈ 22 600 g`, czyli ponad 22 kg — tyle, ile waży średnio pięcio-, sześciolatek! Widać, jak ogromne znaczenie ma gęstość: dwa przedmioty o identycznej objętości mogą różnić się masą kilkudziesięciokrotnie, jeśli są zrobione z materiałów o bardzo różnej gęstości.
