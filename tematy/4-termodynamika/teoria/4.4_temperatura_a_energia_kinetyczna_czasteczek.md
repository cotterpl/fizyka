...
Krok 1 — przeliczamy temperatury na kelwiny (stosujemy tu szkolne zaokrąglenie 273 zamiast dokładnej wartości 273,15 z `wzory.md` — nie zmienia to wyniku):
...
Średnia energia kinetyczna wzrosła tylko około 1,07 raza (czyli o ok. 7%), a nie dwukrotnie.
