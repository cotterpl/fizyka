...
*Wykres zależności prędkości od czasu w spadku swobodnym to linia prosta wychodząca z zera — prędkość rośnie równomiernie o ok. 10 m/s co sekundę (przy $g \approx 10\ \text{m/s}^2$). To potwierdza, że jest to ruch jednostajnie przyspieszony.*
