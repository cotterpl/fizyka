...
Żeby opisać ruch liczbowo, musimy zmierzyć dwie podstawowe wielkości: **drogę** i **czas** (z nich obliczamy prędkość i przyspieszenie).
...
- **Prędkość średnią** na odcinku wyznaczamy, mierząc całą drogę i cały czas jej pokonania, a potem dzieląc: $v_{śr} = s/t$.
...
**Treść zadania:** Uczniowie mierzą prędkość kulki staczającej się z równi. Kulka pokonuje odcinek `2,4 m` w czasie zmierzonym stoperem: `3 pomiary` dały wyniki `1,9 s`, `2,1 s` i `2,0 s`. Oblicz prędkość średnią kulki, korzystając ze średniej arytmetycznej z pomiarów czasu.
